...
public class Registrierung {
	...
	public Registrierung() {
		...
		dlgRegistrierung.getContentPane().setLayout(new MigLayout("",
				"[20.00::20.00,fill][150.00::150.00,fill][10.00::10.00][150.00::150.00,fill][20.00::20.00]",
				"[20.00::20.00,fill][20.00::20.00,fill][20.00::20.00,fill][20.00::20.00,fill][20.00::20.00,fill][20.00::20.00,fill][20.00::20.00,fill][20.00::20.00,fill][20.00::20.00,fill]"));
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (txtBenutzername.getText().length() >= 4) {
					...
					if (String.valueOf(txtPassword).length() >= 6) {
						...
						if (String.valueOf(txtPassword.getPassword())
							...
							if (ret > 0) {
								JOptionPane.showMessageDialog(null,
										txtBenutzername.getText() + " wurde erfolgreich angelegt.",
										"Erfolg!!! (oder so)", JOptionPane.PLAIN_MESSAGE, null);
								dlgRegistrierung.dispose();
							} else {
								JOptionPane.showMessageDialog(null,
										"Fehler beim anlegen von " + txtBenutzername.getText() + ".",
										"Kein Erfolg!!! (oder so)", JOptionPane.PLAIN_MESSAGE, null);
							}
						} else {
						...
						JOptionPane.showMessageDialog(null, "Das Password muss mindestens 6 Zeichen lang sein.",
								"Kein Erfolg!!! (oder so)", JOptionPane.PLAIN_MESSAGE, null);
					}
				} else {
					JOptionPane.showMessageDialog(null, "Der Benutzername muss mindestens 4 Zeichen lang sein.",
							"Kein Erfolg!!! (oder so)", JOptionPane.PLAIN_MESSAGE, null);
				}
			}
		};
		...
		// btnBestaetigen.addActionListener(action); //sonst wird das drei mal
		// ausgeführt
